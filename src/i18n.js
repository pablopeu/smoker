...
const dict = {
  es: {
    ...
    'opening.radiusFb': 'Radio usado: firebox · Ø {d}',
    'opening.radiusCc': 'Radio usado: cámara · Ø {d}',
    'opening.fbConstrains': 'El FB es más chico → el football se arma con su radio.',
  ...
  en: {
    ...
    'opening.radiusFb': 'Radius used: firebox · Ø {d}',
    'opening.radiusCc': 'Radius used: chamber · Ø {d}',
